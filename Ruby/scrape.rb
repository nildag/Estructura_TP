...
articulos.each_with_index do |articulo, i|
  ...
  citado_por = articulo.find_element(:xpath, "//*[@id='gs_res_ccl_mid']/div[#{div_index}]/div[2]/div[3]/a[3]").text rescue "Citado por, no disponible"
  num_citas = citado_por[/\d+/].to_i

  puts "Citado por: #{num_citas}"

  # Intentar interactuar con "Citar"
  begin
...
sleep 60
driver.quit
puts "Datos obtenidos y guardados en web_scraping_citas.csv"